(function () {
  ...
  function normalize(c) {
    ...
    window.D = {
      lesson: meta.lesson || ('Lesson ' + String(lesson).split('-L')[1] || lesson),
      lessonTitle: meta.lessonTitle || meta.title || '',
      lessonEnglishTitle: meta.lessonEnglishTitle || meta.titleEn || '',
